...
SRCS_BONUS = ${PARC_DIR_B}/cub3d.c ${PARC_DIR_B}/map_storage.c ${PARC_DIR_B}/texture_utils.c ${PARC_DIR_B}/map_utils.c ${PARC_DIR_B}/check_closed_map.c ${PARC_DIR_B}/check_circle.c ${PARC_DIR_B}/ft_init_var.c\
		${DRAW_DIR_B}/ft_window.c ${DRAW_DIR_B}/ft_draw.c ${DRAW_DIR_B}/ft_fov.c ${DRAW_DIR_B}/ft_key.c ${DRAW_DIR_B}/handling_key_data.c ${DRAW_DIR_B}/ft_calcul_ray.c ${DRAW_DIR_B}/draw_circle.c ${DRAW_DIR_B}/render_wall.c ${DRAW_DIR_B}/struct.c\
		${UTIL_DIR_B}/get_next_line.c ${UTIL_DIR_B}/get_next_line_utils.c
